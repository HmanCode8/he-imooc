...
<template>
    <div class="pipe-analy">
        ...
        <div class="flex w-full flex-wrap justify-between">
            ...
            <!-- 管龄分析 -->
            <div class="8k:w-1/2 4k:w-full">
                <ThirdLevelTitle class="w-full hover:cursor-pointer" title="管龄分析" @click="global.setCurrentModule(pipeActive+'管龄')"></ThirdLevelTitle>
            ...
            <!-- 管径分析 -->
            <div class="8k:w-1/2 4k:w-full">
                <SecondLevelTitle class="hover:cursor-pointer" title="管径分析" @click="global.setCurrentModule(pipeActive+'管径')"></SecondLevelTitle>
                <Bar3dChart :data="currentData.diameterData" title="管径" class="w-full h-60" />
            </div>

            <!-- 管材分析 -->
            <div class="8k:w-1/2 4k:w-full">
                <SecondLevelTitle class="hover:cursor-pointer" title="管材分析" @click="global.setCurrentModule(pipeActive+'管材')"></SecondLevelTitle>
