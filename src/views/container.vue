        ...
        <div class="main-panel relative">
            ...
            <div class="bg-[url('assets/imgs/bg.jpg')] bg-size bg-center h-[94.5vh] text-white flex overflow-hidden">
                <div ref="leftPanelRef"
                    :class="`bg-[url('assets/imgs/main/panel-left.png')] bg-size backdrop-blur-md 8k:pr-10 4k:pr-6 overflow-auto  absolute w-[28.57%] 8k:w-[3292px] z-10 top-0 left-0 h-full flex-1 bg-opacity-90 p-1 flex flex-col`">
                    <!-- 条件渲染的动态组件 -->
                ...
                <div ref="rightPanelRef"
                    class="bg-[url('assets/imgs/main/panel-right.png')]  bg-size 8k:pl-10 overflow-auto  absolute w-[28.57%] 8k:w-[3292px] z-10 top-0 right-0 h-full flex-1 bg-opacity-90  p-1 flex flex-col">
                    <!-- 条件渲染的动态组件 -->
...
watch(() => store.componentId, (value) => {
    ...
    gsap.fromTo(leftPanelRef.value, { opacity: 1, x: -100 }, { opacity: 1, x: 0, duration: 1, ease: 'linear' })
    gsap.fromTo(rightPanelRef.value, { opacity: 0, x: 100 }, { opacity: 1, x: 0, duration: 1, ease: 'linear' })
